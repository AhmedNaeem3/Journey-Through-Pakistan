...
export default function Profile() {
  ...
  const handleAddFriend = async () => {
    ...
    try {
      console.log('Sending friend request to:', otherUser._id);
      const response = await sendFriendRequest(otherUser._id);
      console.log('Friend request response:', response);
      
      if (response.data) {
        // Update local state
        if (user.sentRequests) {
          user.sentRequests.push(otherUser._id);
        } else {
          user.sentRequests = [otherUser._id];
        }
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      formData.append('name', editProfileData.name.trim());
      if (editProfileData.bio.trim()) formData.append('bio', editProfileData.bio.trim());
      if (editProfileData.city.trim()) formData.append('city', editProfileData.city.trim());
      if (editProfileData.phone.trim()) formData.append('phone', editProfileData.phone.trim());
      if (editProfileData.address.trim()) formData.append('address', editProfileData.address.trim());
      if (editProfileData.postalCode.trim()) formData.append('postalCode', editProfileData.postalCode.trim());
      if (editProfileData.country.trim()) formData.append('country', editProfileData.country.trim());
      ...
      const res = await apiUpdateMe({
        ...
        postalCode: editProfileData.postalCode.trim(),
        country: editProfileData.country.trim()
      });
          ...
          >
            <div className="modal-content">
              ...
              <div className="modal-body" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
                ...
                <div className="mb-4">
                  <h6 className="fw-semibold mb-3" style={{ fontSize: '16px', color: '#050505' }}>Personal Information</h6>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      id="editEmail"
                      className="form-control"
                      value={viewingUser?.email || user?.email || ''}
                      disabled
                      style={{ backgroundColor: '#f0f2f5', opacity: 0.7 }}
                    />
                  </div>
                  
                  <div className="mb-3">
                    <label htmlFor="editBio" className="form-label fw-semibold">Bio (Optional)</label>
                    <textarea
                      id="editBio"
                      className="form-control"
                      rows="4"
                ...
                {/* Contact Information */}
                <div className="mb-4">
                  <h6 className="fw-semibold mb-3" style={{ fontSize: '16px', color: '#050505' }}>Contact Information</h6>
                  
                  <div className="mb-3">
                    <label htmlFor="editPhone" className="form-label fw-semibold">Phone</label>
                    <input
                      type="tel"
                      id="editPhone"
                      className="form-control"
                  ...
                  <div className="mb-3">
                    <label htmlFor="editAddress" className="form-label fw-semibold">Address</label>
                    <textarea
                      id="editAddress"
                      className="form-control"
                      rows="3"
                ...
                <div className="mb-4">
                  <h6 className="fw-semibold mb-3" style={{ fontSize: '16px', color: '#050505' }}>Location</h6>
                  
                  <div className="mb-3">
                    <label htmlFor="editCity" className="form-label fw-semibold">City (Optional)</label>
                    <input
                      type="text"
                      id="editCity"
                      className="form-control"
                  ...
                  <div className="mb-3">
                    <label htmlFor="editPostalCode" className="form-label fw-semibold">Postal Code (Optional)</label>
                    <input
                      type="text"
                      id="editPostalCode"
                      className="form-control"
                  ...
                  <div className="mb-3">
                    <label htmlFor="editCountry" className="form-label fw-semibold">Country (Optional)</label>
                    <input
                      type="text"
                      id="editCountry"
                      className="form-control"
