...
export const getAllPlaces = (params = {}) => api.get('/admin/places', { params });
export const getPlaceById = (placeId) => api.get(`/admin/places/${placeId}`);
...
export const batchApprovePlaces = (placeIds) => api.post('/admin/places/batch-approve', { placeIds });
export const batchRejectPlaces = (placeIds, reason) => api.post('/admin/places/batch-reject', { placeIds, reason });
