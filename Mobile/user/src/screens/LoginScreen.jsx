...
const LoginScreen = () => {
  ...
  const { handleLogin, handleGoogleSignIn, loading } = useAuth();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (err.isNetworkError || (!err.response && err.request)) {
        ...
        errorMessage = 'Server se connect nahi ho raha!\n\nKya karein:\n1. Server start karein\n2. Terminal mein: cd Server\n3. Phir: npm start\n4. Server port 3000 par chalna chahiye';
      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.bottomNote}>
            <Text style={styles.bottomNoteText}>Don't have an account? </Text>
