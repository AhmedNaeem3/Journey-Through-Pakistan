...
router.get('/places', requirePermission(PERMISSIONS.MODERATE_POSTS), getAllPlaces);
router.get('/places/:placeId', requirePermission(PERMISSIONS.MODERATE_POSTS), getPlaceById);
...
router.post('/places/batch-approve', requirePermission(PERMISSIONS.MODERATE_POSTS), batchApprovePlaces);
router.post('/places/batch-reject', requirePermission(PERMISSIONS.MODERATE_POSTS), batchRejectPlaces);
