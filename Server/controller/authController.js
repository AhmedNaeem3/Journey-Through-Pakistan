...
export const authCallback = async (req, res) => {
    try {
        ...
        const tokenResp = await axios.post(`https://${process.env.AUTH0_DOMAIN}/oauth/token`, {
        ...
        const hasAddress = Boolean(
            ...
            (user.shippingAddress.address || user.shippingAddress.postalCode || user.shippingAddress.country)
        );
